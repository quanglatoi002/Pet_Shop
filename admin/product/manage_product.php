...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="sub_category_id" class="control-label">Thể loại cụ thể </label>
                <select name="sub_category_id" id="sub_category_id" class="custom-select" required>
                <option value="" selected="" disabled="">Chọn thể loại đầu tiên</option>
                <?php
...
<script>
	...
	$(document).ready(function(){
        ...
        $('#category_id').change(function(){
            ...
            $('#sub_category_id').select2({placeholder:"Xin chọn ở đây",width:"relative"})
        })
        $('.select2').select2({placeholder:"Vui lòng chọn loại cụ thể",width:"relative"})
